...
describe User, type: :model do
  ...
  context 'user configuration' do
    ...
    it 'updates only show_read_all_tour flag' do
      expect(@user.show_main_tour).to be true
      expect(@user.show_mobile_tour).to be true
      expect(@user.show_read_all_tour).to be true

      @user.update_config show_read_all_tour: false
