...
RSpec.configure do |config|
  ...
  # Yield the receiving instance as the first argument to any_instance implementation blocks.
  # Optional but disabled by default in Rspec 2.99.0, enabled by default in Rspec 3
