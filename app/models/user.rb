...
# - RefreshFeedJobStatus: Each instance of this class associated with a user represents an ocurrence of the user requesting
...
class User < ActiveRecord::Base
  ...
  has_many :refresh_feed_job_statuses, dependent: :destroy
  ...
  # - delete all instances of RefreshFeedJobStatus associated with this feed and user.
  ...
  ##
  # Remove al RefreshFeedJobStatus instances associated with this user and the feed passed as argument

  def remove_refresh_feed_job_statuses(feed)
    RefreshFeedJobStatus.where(user_id: self.id, feed_id: feed.id).destroy_all
  end
