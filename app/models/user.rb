...
class User < ActiveRecord::Base
  ...
  def subscribe(url)
    ...
    feed = subscribe_known_feed feed_url
  ...
  ##
  # Subscribe the user to a feed already in the database.
  #
  # Receives as argument the URL of the feed. It can match the feed.url (normally the website URL) or
  # the feed.fetch_url (the URL from which the feed is fetched).
  #
  # If the user is already subscribed to the feed, raises an AlreadySubscribedError.
  #
  ...
  def subscribe_known_feed(feed_url)
