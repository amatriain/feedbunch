##
# Module with functions related to fetching and parsing feeds

module FeedClientHelpers
  ...
  def feed_parse(feed, feed_response)
  ...
  def feed_autodiscovery(feed, feed_response)
